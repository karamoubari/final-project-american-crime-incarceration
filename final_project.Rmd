...
crime<- crime %>%
 ...
 crime %>% 
  ggplot(crime, mapping= aes(x=year, y= percent_col_pop))+
  geom_line()+
...
crime<- crime %>%
 ...
 crime %>% 
  ggplot(crime, mapping= aes(x=year, y= percent_ver_pop))+
  geom_line()+
...
crime<- crime %>%
 ...
 crime %>% 
  ggplot(crime, mapping= aes(x=year, y= percent_was_pop))+
  geom_line()+
