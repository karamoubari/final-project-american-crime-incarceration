...
crime <- crime %>%
 ...
 crime %>%
  ggplot(crime, mapping = aes(x = year, 
                              y = percent_pop_us))+
  geom_line() +
  labs(title = " Figure 3.1: Percent Population Incarcerated",
       subtitle = "between 2001 and 2016",
       x = "Year", 
       y = "Percent")
```
...
crime<- crime %>%
 ...
 crime %>% 
  ...
  geom_boxplot()+
  labs(title = "Figure 3.2: Percent State Population Incarcerated",
...
col_crime<- crime %>%
 ...
 col_crime %>% 
  ...
  geom_line()+
  labs(title = "Figure 7: Percent Colorado State Population Incarcerated",
  x = "Year", y= "Percent Population Incarcerated") +
  theme_linedraw()
```
...
ver_crime<- crime %>%
 ...
 ver_crime %>% 
  ...
  geom_line()+
  labs(title = "Figure 8: Percent Vermont State Population Incarcerated",
  x = "Year", y= "Percent Population Incarcerated") +
  theme_linedraw()
```
...
was_crime<- crime %>%
 ...
 was_crime %>% 
  ...
  geom_line()+
  labs(title = "Figure 9: Percent Washington State Population Incarcerated",
  x = "Year", y= "Percent Population Incarcerated") +
  theme_linedraw()
```
\newpage
