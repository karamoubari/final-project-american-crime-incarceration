...
between 2001 and 2007 before a steady decrease afterwards. Figure 3.2 shows the same information in terms of the percent of a states population that is incarcerated in a box plot rather than a line graph. The box plot shows that though the median percent of the population does not change significantly from year to year, certain years have a larger spread and large outliers. These outliers are further explained in Figure 4 where we 
...
higher imprisonment proportions than the rest of the country. These are likely the outliers in the boxplot from Figure 3.2. 
 \newpage
